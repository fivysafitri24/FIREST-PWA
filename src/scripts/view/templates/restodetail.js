...
const restoDetail = (resto) => `
  ...
  CONFIG.BASE_IMAGE_LARGE_URL + resto.pictureId
}"/>
    </div>
      ...
      (review) => `
          <div class="detail-review-item">
            <div class="review-header">
              <p class="review-name" title="restaurant" class="fa fa-user-circle" style="font-size:1.3em; padding-right:10px;">${review.name}</p>
